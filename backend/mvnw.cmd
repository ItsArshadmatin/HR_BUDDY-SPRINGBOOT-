...
@REM MAVEN_PROJECTBASEDIR is quoted. If it is already quoted, the next line will create 2 sets of quotes
...
%JAVA_HOME%\bin\java %MAVEN_OPTS% -classpath %MAVEN_WRAPPER_JAR% %WRAPPER_LAUNCHER% %MAVEN_CMD_LINE_ARGS%
